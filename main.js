...
function preload(){
   ...
   console.log(results);
   document.getElementById("sight").innerHTML="I can see..."+results[0].label;
   document.getElementById("point").innerHTML="I am sure about..."+Math.round(results[0].confidence*100)+"%";
   }

   function speak(){
    var synth = window.speechSynthesis;
    var speakthis=new SpeechSynthesisUtterance(sight);
